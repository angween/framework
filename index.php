...
<html lang="id" class="light-style layout-menu-fixed" dir="ltr" data-theme="theme-default" data-assets-path="<?= URL_PUBLIC_VIEW ?>/assets/">
...
<head>
	...
	<!-- icon -->
	<link rel="apple-touch-icon" sizes="180x180" href="<?= URL_PUBLIC_VIEW ?>assets/ico/apple-touch-icon.png">
	<link rel="icon" type="image/png" sizes="32x32" href="<?= URL_PUBLIC_VIEW ?>assets/ico/favicon-32x32.png">
	<link rel="icon" type="image/png" sizes="16x16" href="<?= URL_PUBLIC_VIEW ?>assets/ico/favicon-16x16.png">
	<link rel="manifest" href="<?= URL_PUBLIC_VIEW ?>assets/ico/site.webmanifest">
	<link rel="mask-icon" href="<?= URL_PUBLIC_VIEW ?>assets/ico/safari-pinned-tab.svg" color="#5bbad5">
	<meta name="msapplication-TileColor" content="#da532c">
	<meta name="msapplication-config" content="<?= URL_PUBLIC_VIEW ?>assets/view/images/browserconfig.xml">
	...
	<link rel="stylesheet" href="<?= URL_PUBLIC_VIEW ?>assets/libs/bootstrap/fonts/bootstrap-icons.min.css">

	<!-- Loading script assets -->
	<script src="<?= URL_PUBLIC_VIEW ?>assets/libs/jquery/jquery-3.6.0.min.js"></script>
	<!-- <script src="<?= URL_PUBLIC_VIEW ?>assets/libs/bootstrap/js/popper.min.js"></script> tidak perlu kalau sudah pakai bundle -->
	<script src="<?= URL_PUBLIC_VIEW ?>assets/libs/bootstrap/js/bootstrap.bundle.min.js"></script>
...
<body>
	...
	<script src="<?= URL_PUBLIC_VIEW ?>assets/js/menu.js"></script>
	<script src="<?= URL_PUBLIC_VIEW ?>assets/js/main.js<?= IN_DEVELOPMENT ?>"></script>
</body>
